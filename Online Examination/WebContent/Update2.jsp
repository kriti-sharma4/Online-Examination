...
String sql="Update JAVA Set Question='"+ques+"',Option1='"+option1+"',Option2='"+option2+"',Option3='"+option3+"',Option4='"+option4+"',Answer='"+Ans+"' where sno='"+Serial+"'";
int n=stmt.executeUpdate(sql);
out.println("Number of Questions Updated:"+n);
con.close();
 %>
 <a href="Update2.html">Go Back</a>